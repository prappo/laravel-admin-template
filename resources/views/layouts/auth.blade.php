...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{url('/bower_components/AdminLTE/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{url('home')}}"><b>FB</b>Support</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">@yield('hint')</p>
